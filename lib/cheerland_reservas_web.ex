defmodule CheerlandReservasWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CheerlandReservasWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/cheerland_reservas_web/templates",
        namespace: CheerlandReservasWeb
